...
internal import AttentiveMediaBindings
...
@objcMembers
public class AttentiveRTCSDK: NSObject, Loggable {
...
let sharedLogger = AttentiveRTCSDK.state.logger

// Lazily initialized to the first tracing
let sharedTracing = AttentiveRTCSDK.state.tracing
