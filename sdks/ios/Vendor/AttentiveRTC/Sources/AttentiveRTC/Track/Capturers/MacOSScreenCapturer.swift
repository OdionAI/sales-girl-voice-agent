...
public class MacOSScreenCapturer: VideoCapturer, @unchecked Sendable {
    ...
    override public func startCapture() async throws -> Bool {
        ...
        #if compiler(>=6.4)
        AttentiveObjCHelpers.setWidth(CGDisplayPixelsWide(mainDisplay) * 2,
...
public extension MacOSScreenCapturer {
    internal static let queue = DispatchQueue(label: "AttentiveRTCSDK.MacOSScreenCapturer.sources", qos: .default)
