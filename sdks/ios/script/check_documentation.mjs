...
const prefix = process.argv[2] ? "binary-documentation" : "documentation";
...
let package = Package(
    ...
    dependencies: [.package(name: "AttentiveVoice", path: ${JSON.stringify(packagePath)})],
    targets: [
        .target(name: "DocsCore", dependencies: [
            .product(name: "AttentiveVoice", package: "AttentiveVoice")
        ]),
        .target(name: "DocsCallerUI", dependencies: [
            .product(name: "AttentiveVoice", package: "AttentiveVoice"),
            .product(name: "AttentiveVoiceUI", package: "AttentiveVoice")
        ])
    ],
